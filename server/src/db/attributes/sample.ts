...
const attributes = {
  ...
  computer_certification: [
    [
      Seq.literal(
        'CASE WHEN "computer_certification"."certification" > 0 THEN "computer_certification->computer_certification_type"."description" ELSE ' +
          "'없음'" +
          ' END'
      ),
      'computer_certification'
  ...
  computer: [
    [
      Seq.literal(
        'CASE WHEN "computer"."computer" > 0 THEN "computer->computer_type"."description" ELSE ' +
          "'없음'" +
          ' END'
      ),
      'computer'
  ...
  training: [
    [
      Seq.literal(
        'CASE WHEN "training"."training" > 0 THEN "training->training_type"."description" ELSE ' +
          "'없음'" +
          ' END'
      ),
      'training'
  ...
  work: [
    [
      Seq.literal(
        'CASE WHEN "work"."experience" > 0 THEN "work->experience_type"."description" ELSE ' +
          "'없음'" +
          ' END'
      ),
      'work_experience'
  ...
  vulnerable: [
    ...
    [
      Seq.literal(
        'CASE WHEN "vulnerable"."type" > 0 THEN "vulnerable->vulnerable_type"."description" ELSE ' +
          "'없음'" +
          ' END'
      ),
      'vulnerable'
  ...
  handicap: [
    ...
    [
      Seq.literal(
        'CASE WHEN "handicap"."type" > 0 THEN concat("handicap->handicap_type"."description", ' +
          "'/'" +
  ...
  skills: [
    ...
    [
      Seq.literal(
        '(json_object_agg((CASE WHEN "user_skills"."skill" > 0 THEN "user_skills"."skill" ELSE 0 END), (CASE WHEN "user_skills"."skill" > 0 THEN "user_skills->skills"."description" ELSE ' +
          "'없음'" +
          ' END)))'
      ),
      'skills'
  ...
  careers: [
    [
      Seq.literal(
        `CASE WHEN "careers"."userId" > 0 THEN array_agg(json_build_object('company', "careers"."company", 'position', "careers"."position", 'title', "careers"."title", 'details', "careers"."details", 'pay', "careers"."pay", 'start', "careers"."start", 'end', "careers"."end")) END`
      ),
      'careers'
    ]
  ],
  ...
  militery: [
    [
      Seq.literal(
        'CASE WHEN "militery"."militery" > 0 THEN "militery->militery_type"."description" ELSE ' +
          "'없음'" +
          ' END'
      ),
      'militery'
  ...
  mariage: [
    [
      Seq.literal(
        'CASE WHEN "mariage"."mariage" > 0 THEN "mariage->mariage_type"."description" ELSE ' +
          "'없음'" +
          ' END'
      ),
      'mariage'
  ...
  education: [
    ...
    [
      Seq.literal(
        'CASE WHEN "education"."type" > 0 THEN "education->education_type"."description" ELSE ' +
          "'없음'" +
          ' END'
      ),
      'education'
