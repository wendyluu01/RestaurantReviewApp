...
module.exports = {
    up: (queryInterface, Sequelize) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            const businessList = yield queryInterface.sequelize.query('SELECT id, uuid FROM business', { type: queryInterface.sequelize.QueryTypes.SELECT });
            const businessMap = {};
            yield Promise.all(businessList.map((business) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    down: (queryInterface, Sequelize) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            yield queryInterface.bulkDelete('reviews', null, {});
            return Promise.resolve();
        }
        catch (e) {
            return Promise.reject(e);
